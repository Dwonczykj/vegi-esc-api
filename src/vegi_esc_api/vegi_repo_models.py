...
class VegiUserSql(db.Model, _DBDataClassJsonWrapped, _DBFetchable):
    ...
    _marketingEmailContactAllowed: GColumn[bool] = Column("marketingEmailContactAllowed", Boolean)
    ...
    _marketingPushContactAllowed: GColumn[bool] = Column("marketingPushContactAllowed", Boolean)
    ...
    _marketingPhoneContactAllowed: GColumn[bool] = Column("marketingPhoneContactAllowed", Boolean)
